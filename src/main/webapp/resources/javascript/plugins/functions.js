			...
			'<div class="modal-dialog modal-lg">' +
				...
				'<div class="modal-body">' +
					...
					'<a data-skin="skin-blur-violate" class="col-sm-2 col-xs-4" href="">' +
					    '<img src="' + CONTEXT_ROOT + 'resources/images/skin-violate.jpg" alt="">' +
					'</a>' +
					'<a data-skin="skin-blur-lights" class="col-sm-2 col-xs-4" href="">' +
					    '<img src="' + CONTEXT_ROOT + 'resources/images/skin-lights.jpg" alt="">' +
					'</a>' +
					'<a data-skin="skin-blur-city" class="col-sm-2 col-xs-4" href="">' +
					    '<img src="' + CONTEXT_ROOT + 'resources/images/skin-city.jpg" alt="">' +
					'</a>' +
					'<a data-skin="skin-blur-greenish" class="col-sm-2 col-xs-4" href="">' +
					    '<img src="' + CONTEXT_ROOT + 'resources/images/skin-greenish.jpg" alt="">' +
					'</a>' +
					'<a data-skin="skin-blur-night" class="col-sm-2 col-xs-4" href="">' +
					    '<img src="' + CONTEXT_ROOT + 'resources/images/skin-night.jpg" alt="">' +
					'</a>' +
					'<a data-skin="skin-blur-blue" class="col-sm-2 col-xs-4" href="">' +
					    '<img src="' + CONTEXT_ROOT + 'resources/images/skin-blue.jpg" alt="">' +
					'</a>' +
					'<a data-skin="skin-blur-sunny" class="col-sm-2 col-xs-4" href="">' +
					    '<img src="' + CONTEXT_ROOT + 'resources/images/skin-sunny.jpg" alt="">' +
					'</a>' +
					'<a data-skin="skin-cloth" class="col-sm-2 col-xs-4" href="">' +
					    '<img src="' + CONTEXT_ROOT + 'resources/images/skin-cloth.jpg" alt="">' +
					'</a>' +
					'<a data-skin="skin-tectile" class="col-sm-2 col-xs-4" href="">' +
					    '<img src="' + CONTEXT_ROOT + 'resources/images/skin-tectile.jpg" alt="">' +
					'</a>' +
					'<a data-skin="skin-blur-chrome" class="col-sm-2 col-xs-4" href="">' +
					    '<img src="' + CONTEXT_ROOT + 'resources/images/skin-chrome.jpg" alt="">' +
					'</a>' +
					'<a data-skin="skin-blur-ocean" class="col-sm-2 col-xs-4" href="">' +
					    '<img src="' + CONTEXT_ROOT + 'resources/images/skin-ocean.jpg" alt="">' +
					'</a>' +
					'<a data-skin="skin-blur-sunset" class="col-sm-2 col-xs-4" href="">' +
					    '<img src="' + CONTEXT_ROOT + 'resources/images/skin-sunset.jpg" alt="">' +
					'</a>' +
					'<a data-skin="skin-blur-yellow" class="col-sm-2 col-xs-4" href="">' +
					    '<img src="' + CONTEXT_ROOT + 'resources/images/skin-yellow.jpg" alt="">' +
					'</a>' +
					'<a  data-skin="skin-blur-kiwi"class="col-sm-2 col-xs-4" href="">' +
					    '<img src="' + CONTEXT_ROOT + 'resources/images/skin-kiwi.jpg" alt="">' +
					'</a>' +
					'<a  data-skin="skin-blur-nexus"class="col-sm-2 col-xs-4" href="">' +
					    '<img src="' + CONTEXT_ROOT + 'resources/images/skin-nexus.jpg" alt="">' +
					'</a>' +
				    '</div>' +
				'</div>' +
			    '</div>' +
       ...
       /* var toAnimate = $(this).find('h2').attr('data-value');
        ...
        $({someValue: 0}).animate({someValue: toAnimate}, {
            ...
            step: function() { // called on every step
                ...
                target.text(commaSeparateNumber(Math.floor(this.someValue)));
            },
            complete :function() {
...
$(function(){
    ...
    if (hash != null && hash != ""){
        ...
        if (hash === "#box-register" || hash === "#box-reset"){
